...
/** 
 * DAO for table DBDISEASE.
*/
public class DBDiseaseDao extends AbstractDao<DBDisease, Long> {

    public static final String TABLENAME = "DBDISEASE";

    /**
     * Properties of entity DBDisease.<br/>
    ...
    */
    ...
    public DBDiseaseDao(DaoConfig config) {
        super(config);
    }
    
    public DBDiseaseDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'DBDISEASE' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'DBDISEASE'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DBDisease entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public DBDisease readEntity(Cursor cursor, int offset) {
        DBDisease entity = new DBDisease( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, DBDisease entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DBDisease entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(DBDisease entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
