...
/** 
 * DAO for table BOXED_MEDICINE.
*/
public class BoxedMedicineDao extends AbstractDao<BoxedMedicine, Long> {

    public static final String TABLENAME = "BOXED_MEDICINE";

    /**
     * Properties of entity BoxedMedicine.<br/>
    ...
    */
    ...
    public BoxedMedicineDao(DaoConfig config) {
        super(config);
    }
    
    public BoxedMedicineDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'BOXED_MEDICINE' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'BOXED_MEDICINE'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, BoxedMedicine entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public BoxedMedicine readEntity(Cursor cursor, int offset) {
        BoxedMedicine entity = new BoxedMedicine( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, BoxedMedicine entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(BoxedMedicine entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(BoxedMedicine entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
